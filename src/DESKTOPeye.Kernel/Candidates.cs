...
internal sealed record VisualDescriptor(string Id,string WindowId,VisualFrameRef Frame,RectD Crop,double LocalX,double LocalY,double ScreenX,double ScreenY,int Components,int PixelCount,VisualFeature Feature,long NativeGeneration,long DisplayEpoch);
