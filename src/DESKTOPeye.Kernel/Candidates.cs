...
internal sealed record AppInstanceCandidate(string Id,string AppId,uint ProcessId,long ProcessStartFileTime,string ImagePath,ShellProcessWitness ShellProcess,IdentityEvidence Evidence):Candidate(Id,ConceptKind.AppInstance,AppId,null,IdentityStatus.exact,Evidence);
